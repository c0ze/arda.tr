...
let sections: array<section> = [
  ...
  {
    eyebrow: "04 — Game Ports",
    title: "Game Ports",
    description: "Faithful ports of classic games, rebuilt for the modern web.",
    items: [
      {
        title: "Zork",
        description: "The Zork I–III trilogy, web-playable and illustrated with AI scene art and narration.",
        image: "/zork.webp",
        link: "https://zork.coze.org",
        tags: ["Text Adventure", "AI Art", "Static Web"],
        playable: true,
        containImage: false,
        repo: Some("https://github.com/c0ze/zork"),
      },
      {
        title: "The Slimy Lichmummy",
        description: "A faithful Go port of Ulf Åström's terminal roguelike, true to version 0.40.",
        image: "/tsl.webp",
        link: "https://tsl.coze.org",
        tags: ["Roguelike", "Go", "Terminal"],
        playable: true,
        containImage: false,
        repo: Some("https://github.com/c0ze/tsl-go"),
      },
      {
        title: "A Dark Room",
        description: "A 1:1 port of the minimalist survival classic to Gleam + Lustre — an offline PWA.",
        image: "/adarkroom.webp",
        link: "https://adarkroom.coze.org",
        tags: ["Gleam", "Lustre", "PWA"],
        playable: true,
        containImage: false,
        repo: Some("https://github.com/c0ze/adarkroom-gleam"),
      },
    ],
  },
  {
